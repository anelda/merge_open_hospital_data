...
singularity_level1[1:15,] %>%  kableExtra::kable(caption = "The number times a specific facility type shows up across all datasets when we group by facility name up to admin level 1") %>% 
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover")) 
